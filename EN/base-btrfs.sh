...
echo ""
lsblk -f
read -p "Point ROOT part(ex. sda3, nvme0n1p3):" roott
 mkfs.btrfs /dev/$roott
 mount /dev/$rootT /mnt/
 clear
echo ""
lsblk -f
read -p "Point HOME part(ex. sda4, nvme0n1p4):" home
 mkfs.btrfs /dev/$home
...
do
 ...
 lsblk -f
  echo ""
  echo "The disk will now be marked up."
  echo " Create 4 sections: sda1 , flag boot type linux 83 - boot"
  echo "                    sda2 , type linux 82 solaris   - swap"
  echo "                    sda3 , type linux 83           - root"
  echo "                    sda4 , type linux 83           - home"
  echo "       think twice about sizes! "
