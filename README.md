...
```bash
 pacman -Sy
 curl -OL https://raw.githubusercontent.com/iamm3chanic/ArchLinux-install/version2/RU/base
 chmod +x base
 ./base
```
...
```bash
 pacman -Sy
 curl -OL https://raw.githubusercontent.com/iamm3chanic/ArchLinux-install/version2/EN/base
 chmod +x base
 ./base
```
...
- encryption AFTER logical volume creation and mounting (version3)
